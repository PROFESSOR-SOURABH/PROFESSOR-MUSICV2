...
from PROFESSOR.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from PROFESSOR import Carbon, app
...
@Client.on_callback_query(filters.regex("PROF_playlist") & ~BANNED_USERS)
@languageCB
