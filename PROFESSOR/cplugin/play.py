...
from PROFESSOR.utils.inline import panel_markup_clone
...
from PROFESSOR.utils.decorators.play import CPlayWrapper
...
@Client.on_callback_query(filters.regex("PROFmousAdmin") & ~BANNED_USERS)
async def PROFmous_check(client: Client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@Client.on_callback_query(filters.regex("PROFPlaylists") & ~BANNED_USERS)
@languageCB
...
import config
from PROFESSOR import Carbon, YouTube
from PROFESSOR.core.call import PROF
