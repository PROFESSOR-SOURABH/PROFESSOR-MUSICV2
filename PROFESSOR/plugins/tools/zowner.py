...
from PROFESSOR.utils.database import add_served_chat, delete_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from PROFESSOR.utils.database import get_assistant
import asyncio
from PROFESSOR.misc import SUDOERS
from PROFESSOR.mongo.afkdb import LOGGERS as OWNERS
...
from PROFESSOR.utils.decorators.userbotjoin import UserbotWrapper
...
async def add_allbot(client, message):
    ...
    if len(command_parts) != 2:
        await message.reply(
            "**⚠️ ɪɴᴠᴀʟɪᴅ ᴄᴏᴍᴍᴀɴᴅ ғᴏʀᴍᴀᴛ. ᴘʟᴇᴀsᴇ ᴜsᴇ ʟɪᴋᴇ » `/gadd @MusicBestCloner_Bot`**"
        )
        return
